...
INSERT INTO case_study_furama_web.customer_type(name)
VALUE ('Diamond'),
	  ('Platinium'),
      ('Gold'),
      ('Silver'),
...
INSERT INTO case_study_furama_web.customer (name, day_of_birth, gender, id_card, phone_number, email, address, customer_type_id) 
VALUE
...
INSERT INTO case_study_furama_web.attach_facility (name, cost, unit, status) 
VALUE
...
INSERT INTO case_study_furama_web.contract (start_day, end_day, deposit, employee_id, customer_id, facility_id) 
VALUE
...
INSERT INTO case_study_furama_web.contract_detail (quantity, contract_id, attach_facility_id) 
VALUE
(5, 2, 4),
(8, 2, 5),
(15, 2, 6),
